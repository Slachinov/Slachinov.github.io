...
let m=qq.reg.get('panels').main;m.innerText=o[this.u]}}else if(u1=='els'){ff=async function(){let ht=proj.val[u1][this.u]['html'];let f=qq.reg.get('htmltotable');let d=qq.reg.get('panels').propertes;f(ht,d);}};//alert(f);

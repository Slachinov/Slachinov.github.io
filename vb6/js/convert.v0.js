...
//---
let el2=qq.f.crElem({tag :'div',attr:{contentEditable:true},style:{border:'1px solid black', background:'lightgray',left:'1px',right:'1px','font-size':'15px'},event:{dblclick:async function(e){let pan= qq.reg.get('panels').edit;pan.innerText=txt1;pan.elem=this.elem;pan.nm='';}},it:txt1,parent:bs});el2.elem=el2;};
//----
};

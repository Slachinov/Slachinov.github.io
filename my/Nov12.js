...
t=qq.ce({tag:'div', style:{position :'absolute',top:'0px',left:'0px', background :'yellow',border:'1px solid orange'},prop:{clear:function (){this.innerHTML='';}}});
...
qq.ce(fs,{tag:'button', style:{}, event:{click: async function (){f.at();f.all();f.ed();all.show();}},it: 'ataix' , parent :b});

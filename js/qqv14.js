...
//
qq.anim=function(el,x,t) {return new Promise(function(resolve, reject) {$(el).animate(x,t,function(){resolve()});;})};
qq.pause=function (t){return new Promise(function(resolve, reject) {setTimeout(function(){resolve()},t)})};

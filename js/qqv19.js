...
var eventBase={prop:{hide:function(){this._display=this.getStyle('display');this.style.display='none'},show:function(){let st=this._display||'block';this.style.display=st;},toggle:function(){if(this.style.display!='none')this.hide();else this.show()},getStyle:function(style){return document.defaultView.getComputedStyle(this,null).getPropertyValue(style)}}};
//----

...
parent:consoleBox,
event:{
click(){createMiniPanel();consoleBox.hide()},
longtap(){}
}
})
consoleBox.hide()
...
miniPanel.startX=touch.clientX
miniPanel.startY=touch.clientY
...
e.preventDefault()
const touch=e.touches[0]
const dx=touch.clientX-miniPanel.startX
const dy=touch.clientY-miniPanel.startY
miniPanel.style.left=miniPanel.origLeft+dx+'px'
miniPanel.style.top=miniPanel.origTop+dy+'px'
}
},
ih:'☰'
})

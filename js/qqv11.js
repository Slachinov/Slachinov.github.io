...
qq.lf={};
qq.lf.run=function (a){
localforage.getItem(a,function (e,v){console.log(a +' is loaded');eval(v.text)});};
qq.sh={};
...
//---
qq.html=document.createElement ('div');
localforage.getItem ("qqhtml",function (e,v){eval(v.text);});
//---
qq.lf.run('klass0',function (e,v)
{});
//alert("new qq v1-1");
